...
{
  description =
    "Nix flake for pythoneda-shared-artifact/events-infrastructure";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.22";
        sha256 = "0hi09w0ap191bqnwvh2f6afl60i68p0gpfwwr6701gkyg1rwsxw6";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-artifact-events-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-events} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-events-infrastructure-python312;
          ...
          pythoneda-shared-artifact-events-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-events-infrastructure-python312;
          ...
          pythoneda-shared-artifact-events-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-events-infrastructure-python313;
